            ...
            {!modalClosed && <div className="h-screen w-screen fixed top-0 z-40 flex justify-center items-center">
                ...
                <div className="flex flex-col justify-center h-screen w-screen relative z-50 items-center ">
                    <div className="gap-4 bg-black opacity-100 h-2/3 w-2/3 border-white-[1px] flex flex-col justify-center text-center p-4">
                        ...
                        <p className='text-white'>La locación del evento se trasladó al Museo de la Ciudad (Bv. Oroño 2361). Si ya te acreditaste, no es necesario que vuelvas a llenar el formulario. Las acreditaciones llegarán el 10 de diciembre al mail que ingresaste. Si no recibís tu acreditación, contactate a somoscorrientealterna@gmail.com</p>
